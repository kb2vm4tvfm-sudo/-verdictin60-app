"""Batch tab construction, moved from app.py (Phase 8 refactor, no behavior change).

``build_batch_tab(app, parent)`` builds the widgets exactly as the former
``App._build_batch_tab`` method did, with all callbacks still pointing back
