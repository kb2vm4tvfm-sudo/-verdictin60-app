"""URL-import tab construction, moved from app.py (Phase 8 refactor, no behavior change).

``build_url_tab(app, parent)`` builds the widgets exactly as the former
``App._build_url_tab`` method did, with all callbacks still pointing back
