"""Single-export tab construction, moved from app.py (Phase 8 refactor, no behavior change).

``build_single_tab(app, parent)`` builds the widgets exactly as the former
``App._build_single_tab`` method did, with all callbacks still pointing back
to the running ``App`` instance passed in as ``app``.
"""
import tkinter as tk
from tkinter import ttk

from verdictin60_ui import BG, WHITE, CRIMSON, CRIMSON_HOT, MUTED, LIGHT_GRAY, _make_lbtn, _lbtn_disable
...
def build_single_tab(app, parent):
    ...
    card_inner = tk.Frame(app._card_frame, bg="#1a1a1a",
    ...
    _lbtn_disable(app._btn_export, MUTED, "#888888")
